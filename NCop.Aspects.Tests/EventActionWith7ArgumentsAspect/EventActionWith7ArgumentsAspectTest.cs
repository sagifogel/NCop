...
using NCop.Aspects.Tests.EventActionWith7ArgumentsAspect.Subjects;
...
{
    [TestClass]
    public class EventActionWith7ArgumentsAspectTest : AbstractAspectTest
    {
        ...
        [TestMethod]
        public void EventActionWith7Arguments_AnnotatedWithOnEventInterceptionAspect_ReturnsTheCorrectSequenceOfAdvices() {
            ...
            instance.RaiseInterceptionAspect(firstArg1List, firstArg2List, firstArg3List, firstArg4List, firstArg5List, firstArg6List, firstArg7List);
            instance.InterceptionAspect -= action;
            instance.RaiseInterceptionAspect(secondArg1List, secondArg2List, secondArg3List, secondArg4List, secondArg5List, secondArg6List, secondArg7List);
        ...
        [TestMethod]
        public void EventActionWith7Arguments_AnnotatedWithMultipleOnEventInterceptionAspect_ReturnsTheCorrectSequenceOfAdvices() {
            var firstArg1List = new List<AspectJoinPoints>();
            var firstArg2List = new List<AspectJoinPoints>();
            var firstArg3List = new List<AspectJoinPoints>();
            var firstArg4List = new List<AspectJoinPoints>();
            ...
            instance.RaiseMultipleInterceptionAspect(firstArg1List, firstArg2List, firstArg3List, firstArg4List, firstArg5List, firstArg6List, firstArg7List);
            instance.MultipleInterceptionAspects -= action;
            instance.RaiseMultipleInterceptionAspect(secondArg1List, secondArg2List, secondArg3List, secondArg4List, secondArg5List, secondArg6List, secondArg7List);
