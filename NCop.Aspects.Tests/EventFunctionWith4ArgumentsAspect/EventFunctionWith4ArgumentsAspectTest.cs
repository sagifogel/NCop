...
using NCop.Aspects.Tests.EventFunctionWith4ArgumentsAspect.Subjects;
...
{
    [TestClass]
    public class EventFunctionWith4ArgumentsAspectTest : AbstractAspectTest
    {
        ...
        [TestMethod]
        public void EventFunctionWith4Arguments_AnnotatedWithOnEventInterceptionAspect_ReturnsTheCorrectSequenceOfAdvices() {
            ...
            Func<List<AspectJoinPoints>, List<AspectJoinPoints>, List<AspectJoinPoints>, List<AspectJoinPoints>, string> func = (l1, l2, l3, l4) => instance.Values.Append(AspectJoinPoints.Intercepted).ToString();

            instance.InterceptionAspect += func;
            firstResult = instance.RaiseInterceptionAspect(firstArg1List, firstArg2List, firstArg3List, firstArg4List);
            instance.InterceptionAspect -= func;
            secondResult = instance.RaiseInterceptionAspect(secondArg1List, secondArg2List, secondArg3List, secondArg4List);
        ...
        [TestMethod]
        public void EventFunctionWith4Arguments_AnnotatedWithMultipleOnEventInterceptionAspect_ReturnsTheCorrectSequenceOfAdvices() {
            string firstResult = null;
            string secondResult = null;
            var firstArg1List = new List<AspectJoinPoints>();
            var firstArg2List = new List<AspectJoinPoints>();
            ...
            firstResult = instance.RaiseMultipleInterceptionAspect(firstArg1List, firstArg2List, firstArg3List, firstArg4List);
            instance.MultipleInterceptionAspects -= func;
            secondResult = instance.RaiseMultipleInterceptionAspect(secondArg1List, secondArg2List, secondArg3List, secondArg4List);
