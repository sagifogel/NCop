...
using NCop.Aspects.Tests.FunctionWith8RefArgumentsAspect.Subjects;
using System;

namespace NCop.Aspects.Tests
{
    [TestClass]
    public class FunctionWith8RefArgumentsAspectTest : AbstractAspectTest
    {
        private int i = 0;
        private int j = 0;
        private int k = 0;
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_AnnotatedWithOnMethodBoundaryAspect_ReturnsTheCorrectSequenceOfAdvices() {
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_AnnotatedWithInterceptionAspect_ReturnsTheCorrectSequenceOfAdvices() {
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_AnnotatedWithMultipleInterceptionAspects_ReturnsTheCorrectSequenceOfAdvices() {
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_AnnotatedWithMultipleOnMethodBoundaryAspects_ReturnsTheCorrectSequenceOfAdvices() {
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_AnnotatedWithAllAspectsStartingWithInterceptionAspect_ReturnsTheCorrectSequenceOfAdvices() {
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_AnnotatedWithAllAspectsStartingWithOnMethodBoundaryAspect_ReturnsTheCorrectSequenceOfAdvices() {
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_AnnotatedWithAlternateAspectsStartingWithInterceptionAspect_ReturnsTheCorrectSequenceOfAdvices() {
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_AnnotatedWithAlternateAspectsStartingWithOnMethodBoundaryAspect_ReturnsTheCorrectSequenceOfAdvices() {
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        public void FunctionWith8RefArguments_AnnotatedWithOnMethodBoundaryAspectThatRaisesAnExceptionInMethodInvocationWithDefaultFlowBehaviour_ThrowsException() {
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_AnnotatedWithOnMethodBoundaryAspectThatRaisesAnExceptionInMethodInvocationWithContinueFlowBehaviour_OmitsTheOnSuccessAdvice() {
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_AnnotatedWithATryFinallyOnMethodBoundaryAspectThatRaisesAnExceptionInMethodInvocation_OmitsTheOnSuccessAdviceAndReturnsTheCorrectSequenceOfAdvices() {
            string result = null;
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_OnMethodBoundaryAspectThatRaisesAnExceptionInMethodInvocationWithoutTryFinally_OmitsTheOnSuccessAdviceAndReturnsTheCorrectSequenceOfAdvices() {
            string result = null;
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
        ...
        [TestMethod]
        public void FunctionWith8RefArguments_OnMethodBoundaryAspectWithOnlyOnEntryAdvice_ReturnsTheCorrectSequenceOfAdvices() {
            var instance = container.Resolve<IFunctionWith8RefArgumentsComposite>();
