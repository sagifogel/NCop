...
namespace NCop.Aspects.Advices
{
	...
	{
        private readonly OnAddEventHandlerAdviceAttribute advice = null;

        public OnAddHandlerAdviceDefinition(OnAddEventHandlerAdviceAttribute advice, MethodInfo adviceMethod)
