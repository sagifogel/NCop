...
namespace NCop.Aspects.Engine
{
    public abstract class AbstractFunctionEventBroker<TInstance, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult> : IEventBroker<Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult>>
    {
        ...
        protected AbstractFunctionEventBroker(TInstance instance, EventInfo @event, Func<IEventFunctionArgs<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult>, TResult> argsHandler) {
            this.@event = @event;
