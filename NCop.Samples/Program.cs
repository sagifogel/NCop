...
namespace NCop.Samples
{
	...
	public sealed class MethodDecoratorFunctionBinding : IActionBinding<CSharpDeveloperMixin, int, int>
	{
		...
		public void Proceed(ref CSharpDeveloperMixin instance, IActionArgs<int, int> args) {
			var args1 = args.Arg1;
			var args2 = args.Arg2;

			instance.Code(ref args1, args2);
		}

		public void Invoke(ref CSharpDeveloperMixin instance, IActionArgs<int, int> args) {
			var arg1 = args.Arg1;
			var arg2 = args.Arg2;
			
			instance.Code(ref arg1, arg2);
	...
	//		var interceptionArgs = new ActionInterceptionArgsImpl<CSharpDeveloperMixin, int>(instance, args.Method, null, args.Arg1);
	...
	public class Person : IPersonComposite
	{
		...
		public void Code(ref  int i, int j) {
			var codeMethod = developer.GetType().GetMethods()[0];
			var interArgs = new ActionInterceptionArgsImpl<CSharpDeveloperMixin, int, int>(developer, codeMethod, MethodDecoratorFunctionBinding.singleton, i, j);
	...
	class Program
	{
		static void Main(string[] args) {
			int i = 0, j = 0;
			new Person().Code(ref i, j); return;
	...
	{
		public override void Code(ref int i, int j) {
			i = 10;
		}
	}
		...
		where TLanguage : ILanguage, new()
	{
		...
		public virtual void Code(ref int i, int j) {
