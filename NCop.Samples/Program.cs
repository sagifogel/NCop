...
namespace NCop.Samples
{
	...
	public interface IPersonComposite : IDeveloper<object[]>
	{
	}

	public class CSharpDeveloperMixin : AbstractDeveloper<string[]>
	{
	...
	public abstract class AbstractDeveloper<TLanguage> : IDeveloper<TLanguage>
	{
		public virtual string Code() {
			return string.Empty;// Language.Description.ToString();
		}
	}
